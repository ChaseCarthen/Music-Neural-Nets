...
import os
import sys
#A new addition that includes -- the ability to convert stuff
...
updates_generate : dictionary of Theano variable -> Theano variable
  ...
  generation function.'''
    ...
    (v_t, u_t), updates_generate = theano.scan(
        ...
        outputs_info=[None, u0], non_sequences=params, n_steps=777)
...
dt : float
  ...
  equivalently the time difference between consecutive time steps.'''
    ...
    def train(self, files, batch_size=100, num_epochs=777):
